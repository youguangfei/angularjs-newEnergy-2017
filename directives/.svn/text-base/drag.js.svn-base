...
function(t) {
	...
	var o = n(1),
		r = n(2),
		i = r.module("angular-drag", []);
	i.directive("drag", function() {
		return {
			restrict: "A",
			link: function(t, e) {
				var n = e[0],
					r = n.querySelector("[drag-handle]");
				r || new o(n)
			}
		}
...
//				console.log(n);
	...
	var s = n(3),
		...
		h = !("minWidth" in d.style),
		f = !h && "onlosecapture" in d,
		l = "setCapture" in d,
		p = {
	...
	i.prototype = {
		...
		var o, r, a, d, h, f, l, p, m, v, x = s(t),
			y = this,
			T = new i;
		"undefined" == typeof n && (n = !! g), this.GPU = n, T.onstart = function(e) {
			var n = "BODY" === t.parentNode.nodeName ? c : x.offsetParent(),
				i = "fixed" === x.css("position"),
				s = x.position(),
				g = u.width(),
				T = u.height(),
				w = n.scrollLeft(),
