App.directive('paneltool', ["$compile", "$timeout", function($compile, $timeout){
  var templates = {
    collapse:"<a href='javascript:;' panel-collapse='' ng-click='{{panelId}} = !{{panelId}}'> \
                <em ng-show='{{panelId}}' class='fa fa-qrcode mr-sm'></em> \
                <em ng-show='!{{panelId}}' class='fa fa-qrcode mr-sm'></em> \
              </a>",
    dismiss: "",
    refresh: "<a href='javascript:;' panel-refresh='' data-spinner='{{spinner}}' tooltip='Refresh Panel'>\
