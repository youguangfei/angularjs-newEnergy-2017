            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay" ></div><div id="ngdialogContent" class="ngdialog-content" style="width:'+ options.width +'"  role="document">' + template + '</div>' :
                    ...
                    openCustomConfirm: function (opts) {
                        opts.templateUrl = 'template/delete.html';
                        //opts.className = 'ngdialog-theme-plain';
                        opts.className = opts.className||'ngdialog-theme-default';
